...
const Certificates: React.FC = () => {
  ...
  const certificates: Certificate[] = [
    ...
    },
    {
      ...
      verificationUrl: '',
      image: '/certificates/oracle-certifications.jpeg',
      downloadUrl: '/certificates/oracle-certifications.jpeg',
      status: 'Completed',
      rating: 5,
    ...
    },
    {
      ...
      verificationUrl: '',
      image: '/certificates/openai-generative-pretrained-gpt3-for-developers.png',
      downloadUrl: '/certificates/openai-generative-pretrained-gpt3-for-developers.png',
      status: 'Completed',
      rating: 5,
      category: 'Professional Certifications'
    },
